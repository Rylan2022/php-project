<?php require_once 'common/navbar.php';?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="pages-image">
                            <img src="assets/img/pages/pages-10.jpg" alt="pages-image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="register-area ptb-100">
            <div class="container">
                <div class="single-register-info">
                    <h3>Register Now</h3>
                    <form>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">
                                I agree to the <a class="text-decoration-none" href="privacy-policy.php">privacy policy</a>
                            </label>
                        </div>
                        <button class="default-btn border-0">
                            Register Now
                            <i class="flaticon-right-arrow"></i>
                        </button>
                    </form>
                    <p>Already have an account? Please <a class="text-decoration-none" href="login.php">Login Here</a></p>
                </div>
            </div>
        </div>
        <!-- End Register Area -->
